...
<div x-data="{ editingProposal: null }" class="flex h-screen font-sans overflow-hidden bg-gray-100">
    ...
    <main class="flex-1 flex flex-col max-h-screen overflow-y-auto">
        ...
        <div class="p-6 max-w-7xl mx-auto bg-white mt-6 rounded shadow min-h-[60vh] flex flex-col">
            ...
            <a href="<?php echo e(route('captain.proposals.create')); ?>" class="bg-blue-600 text-white px-4 py-2 rounded mb-4 inline-block">
                + Create Proposal
            </a>
        ...
        <!-- Edit Modal -->
        <div x-show="editingProposal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div class="bg-white rounded-lg shadow-lg w-full max-w-xl p-6 relative" @click.outside="editingProposal = null" x-cloak>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Acer\OneDrive\Desktop\Laovista\laovista\resources\views/captain/proposals/approved.blade.php ENDPATH**/ ?>