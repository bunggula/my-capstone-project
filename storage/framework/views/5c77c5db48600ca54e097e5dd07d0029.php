...
<?php $__env->startSection('title', 'Barangay Secretaries'); ?>
...
<div x-data="secretaryManager()" class="flex h-screen overflow-hidden bg-gray-100">
    ...
    <main class="flex-1 flex flex-col overflow-hidden">
        <?php echo $__env->make('partials.captain-header', ['title' => 'Barangay Secretaries'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        ...
                        <tbody class="divide-y divide-gray-200">
                            <?php $__empty_1 = true; $__currentLoopData = $secretaries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $secretary): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="<?php echo e($loop->even ? 'bg-gray-100' : 'bg-white'); ?> hover:bg-gray-200">
                                  ...
                                  <td class="px-4 py-2">
    <?php echo e($secretary->first_name); ?> <?php echo e($secretary->middle_name ? $secretary->middle_name.' ' : ''); ?><?php echo e($secretary->last_name); ?>

</td>

                                    <td class="px-4 py-2"><?php echo e($secretary->email); ?></td>
                                    <td class="px-4 py-2 capitalize"><?php echo e($secretary->gender); ?></td>
                                    <td class="px-4 py-2"><?php echo e($secretary->birthday ? \Carbon\Carbon::parse($secretary->birthday)->format('M d, Y') : 'N/A'); ?></td>
    ...
    @click="loadEditSecretary(
        <?php echo e($secretary->id); ?>, 
        '<?php echo e($secretary->first_name); ?>', 
        '<?php echo e($secretary->middle_name); ?>', 
        '<?php echo e($secretary->last_name); ?>', 
        '<?php echo e($secretary->email); ?>', 
        '<?php echo e($secretary->gender); ?>', 
        '<?php echo e($secretary->birthday); ?>'
    )"
...
>
    ...
    <button type="button" @click="confirmToggle(<?php echo e($secretary->id); ?>, '<?php echo e($secretary->status); ?>', '<?php echo e($secretary->name); ?>')"
        ...
        title="<?php echo e($secretary->status === 'active' ? 'Deactivate' : 'Activate'); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Acer\OneDrive\Desktop\Laovista\laovista\resources\views/captain/secretary/index.blade.php ENDPATH**/ ?>