...
<!-- White Sidebar -->
<div x-data="{ openDropdown: '<?php echo e((request()->routeIs('captain.documents.*') || request()->routeIs('captain.manage.*')) 
        ? 'services' 
    ...
    <div style="margin-bottom: 32px; text-align: center;">
        <a href="<?php echo e(route('captain.dashboard')); ?>" style="text-decoration: none; color: #1e3a8a; font-size: 20px; font-weight: 700;">
             Captain Panel
        </a>
    </div>
    ...
    <nav style="display: flex; flex-direction: column; gap: 16px;">
        ...
        <a href="<?php echo e(route('captain.dashboard')); ?>" 
           class="sidebar-link <?php echo e(request()->routeIs('captain.dashboard') ? 'active' : ''); ?>">
        ...
        <div class="relative">
            ...
            <div x-show="openDropdown === 'services'" x-transition x-cloak class="ml-4 mt-2 flex flex-col space-y-1">
                <a href="<?php echo e(route('captain.documents.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('captain.documents.*') ? 'active' : ''); ?>">
                    <i data-lucide="inbox" class="icon"></i>
                    <span>Document Request</span>
                </a>
                <a href="<?php echo e(route('captain.manage.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('captain.manage.*') ? 'active' : ''); ?>">
        ...
        <div class="relative">
            ...
            <div x-show="openDropdown === 'population'" x-transition x-cloak class="ml-4 mt-2 flex flex-col space-y-1">
                <a href="<?php echo e(route('captain.residents.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('captain.residents.*') ? 'active' : ''); ?>">
                    <i data-lucide="user" class="icon"></i>
                    <span>List of Residents</span>
                </a>
                <a href="<?php echo e(route('captain.new.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('captain.new.*') ? 'active' : ''); ?>">
        ...
        <div class="relative">
            ...
            <div x-show="openDropdown === 'events'" x-transition x-cloak class="ml-4 mt-2 flex flex-col space-y-1">
                <a href="<?php echo e(route('captain.events.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('captain.events.*') ? 'active' : ''); ?>">
                    <i data-lucide="calendar-check" class="icon"></i>
                    <span>Barangay Events</span>
                </a>
                <a href="<?php echo e(route('captain.announcements.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('captain.announcements.*') ? 'active' : ''); ?>">
                    <i data-lucide="message-square" class="icon"></i>
        ...
        <!-- Other Links -->
        <a href="<?php echo e(route('captain.proposal.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('captain.proposal.index') ? 'active' : ''); ?>">
            <i data-lucide="file-text" class="icon"></i>
            <span>Proposals</span>
        </a>

        <a href="<?php echo e(route('captain.concerns.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('captain.concerns.*') ? 'active' : ''); ?>">
            <i data-lucide="alert-triangle" class="icon"></i>
            <span>General Concerns</span>
        </a>

        <a href="<?php echo e(route('captain.barangay-info.show')); ?>" class="sidebar-link <?php echo e(request()->routeIs('captain.barangay-info.*') ? 'active' : ''); ?>">
            <i data-lucide="info" class="icon"></i>
            <span>Barangay Info</span>
        </a>

        <a href="<?php echo e(route('captain.secretary.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('captain.secretary.*') ? 'active' : ''); ?>">
            <i data-lucide="user-plus" class="icon"></i>
...
<?php /**PATH C:\Users\Acer\OneDrive\Desktop\Laovista\laovista\resources\views/partials/captain-sidebar.blade.php ENDPATH**/ ?>