...
<div class="flex w-screen h-screen font-sans overflow-hidden">
    ...
    <div class="mb-6">
        <a href="<?php echo e(route('captain.events.pending')); ?>"
    ...
    <?php $__empty_1 = true; $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div class="bg-gray-50 border border-gray-200 p-4 mb-6 rounded-lg shadow-sm">
            <h2 class="text-lg font-semibold text-red-700 mb-1"><?php echo e($event->title); ?></h2>
            ...
            <p class="text-sm text-gray-700 mb-2 whitespace-pre-line"><?php echo e($event->details); ?></p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Acer\OneDrive\Desktop\Laovista\laovista\resources\views/captain/events/rejected.blade.php ENDPATH**/ ?>