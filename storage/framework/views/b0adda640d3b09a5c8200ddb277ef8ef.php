...
<?php $__env->startSection('title', 'BRCO Reports '); ?>
...
<div class="flex font-sans min-h-screen overflow-hidden">
  ...
  <div class="p-6 flex-1">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <form id="dateFilterForm" method="GET" action="<?php echo e(route('secretary.brco.index')); ?>" class="flex gap-2 items-center">
...
<input type="date" name="to_date" id="to_date" 
       ...
       class="border p-1 rounded">
            ...
            <a href="<?php echo e(route('secretary.brco.index')); ?>" id="resetFilter" 
               class="bg-red-500 text-white px-3 py-1 rounded hover:bg-gray-600 <?php echo e((request('from_date') || request('to_date')) ? '' : 'hidden'); ?>">
               Clear
            </a>

            <a href="<?php echo e(route('secretary.brco.print', request()->only(['from_date','to_date']))); ?>" 
   id="printButton"
   target="_blank"
   class="bg-green-700 text-white px-3 py-1 rounded hover:bg-gray-800 flex items-center justify-center <?php echo e((request('from_date') && request('to_date')) ? '' : 'hidden'); ?>">
        ...
        <tbody>
           ...
           <tr class="<?php echo e($loop->even ? 'bg-gray-100' : 'bg-white'); ?> hover:bg-gray-200">
               <td class="border px-3 py-2 text-center">
                ...
                <td class="border p-2"><?php echo e($report->location); ?></td>
                <td class="border p-2"><?php echo e($report->length); ?></td>
              <td class="border p-2">
    <?php echo e(\Carbon\Carbon::parse($report->date)->format('F d, Y')); ?>

</td>

                <td class="border p-2 text-center">
                <button onclick="openViewModal(<?php echo e($report->id); ?>)" 
...
<button onclick="openEditModal(<?php echo e($report->id); ?>)" 
...
<div id="report-<?php echo e($report->id); ?>" class="hidden">
    <table class="w-full border-collapse border border-gray-500 text-sm text-center">
        ...
        <tbody>
            <tr>
                <td class="border p-2"><?php echo e($report->conducted ? '✔ Yes' : '✘ No'); ?></td>
                <td class="border p-2"><?php echo e($report->location); ?></td>
                <td class="border p-2"><?php echo e($report->length); ?></td>
                <td class="border p-2"><?php echo e(\Carbon\Carbon::parse($report->date)->format('M d, Y')); ?></td>
                <td class="border p-2"><?php echo e($report->action_taken); ?></td>
                <td class="border p-2"><?php echo e($report->remarks ?? '-'); ?></td>
            </tr>
        </tbody>
    </table>
    ...
    <div class="mt-4">
        ...
        <div class="flex gap-2 flex-wrap">
            <?php $__empty_1 = true; $__currentLoopData = $report->photos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="flex flex-col gap-1 items-center">
                <img src="<?php echo e(asset('storage/'.$photo->path)); ?>" class="w-32 h-32 object-cover rounded border">
                <?php if(!empty($photo->caption)): ?>
                <span class="text-sm text-gray-600"><?php echo e($photo->caption); ?></span>
                <?php endif; ?>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<div id="createModal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    <div class="bg-white p-6 rounded-2xl shadow-lg w-full max-w-3xl max-h-screen overflow-y-auto">
        ...
        <!-- Form -->
        <form id="createForm" action="<?php echo e(route('secretary.brco.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
            <?php echo csrf_field(); ?>
...
<script>
    const reports = <?php echo json_encode($reports->keyBy('id'), 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Acer\OneDrive\Desktop\Laovista\laovista\resources\views/secretary/brco/index.blade.php ENDPATH**/ ?>