...
<head>
    ...
    <style>
        ...
        /* Header */
        .header { display: flex; align-items: center; justify-content: center; gap: 15px; line-height: 1.4; margin-bottom: 20px; }
        ...
        .footer .prepared { margin-top: 60px; text-align: right; }
...
<p class="info">List of Residents of Barangay <?php echo e($barangayName ?? 'All Barangays'); ?><?php echo e(count($filters) ? ' | '.$filtersText : ''); ?></p>
...
<div class="footer">
    ...
    <div class="prepared" style="text-align:left; margin-top:60px;">
        ...
        <p><?php echo e($user->role == 'secretary' ? 'Barangay Secretary' : 'User'); ?></p>
    </div>
</div>
...
<?php /**PATH C:\Users\Acer\OneDrive\Desktop\Laovista\laovista\resources\views/secretary/residents/print.blade.php ENDPATH**/ ?>