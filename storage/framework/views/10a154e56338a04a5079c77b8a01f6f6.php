...
<div class="flex h-screen bg-gray-100">
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <main class="flex-1 overflow-auto p-6">
            ...
            <!-- Page Title -->
            <div class="mb-4">
                <h2 class="text-lg font-semibold">Manage Documents</h2>
            </div>
                                ...
                                <tr class="<?php echo e($loop->even ? 'bg-gray-50' : 'bg-white'); ?> hover:bg-gray-100 transition">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex space-x-2 items-center">
                                            ...
                                            <!-- Hidden delete form -->
                                            <form id="delete-form-<?php echo e($document->id); ?>" action="<?php echo e(route('secretary.documents.destroy', $document->id)); ?>" method="POST" class="hidden">
                                                <?php echo csrf_field(); ?>
...
<div id="addModal" class="fixed inset-0 bg-black bg-opacity-50 hidden flex items-center justify-center z-50">
    <div class="bg-white rounded-xl shadow-lg w-full max-w-xl p-6">
        ...
        <form action="<?php echo e(route('secretary.documents.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="mb-4">
...
function fetchDocument(id) {
    fetch("<?php echo e(url('/secretary/documents')); ?>/" + id + "/edit")
        .then(res => res.json())
        .then(data => {
            document.getElementById('editForm').action = "<?php echo e(url('/secretary/documents')); ?>/" + id;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Acer\OneDrive\Desktop\Laovista\laovista\resources\views/secretary/documents/index.blade.php ENDPATH**/ ?>