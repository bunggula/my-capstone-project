    ...
    <div x-cloak x-data="{ open: false, loggingOut: false }" class="relative">
        ...
        >
            <div class="px-4 py-2 font-semibold text-gray-600 border-b">
                <?php echo e(Auth::user()->first_name ?? 'ABC'); ?>

            </div>
            <a href="<?php echo e(route('settings.profile')); ?>" class="block px-4 py-2 hover:bg-gray-100">Edit Profile</a>
            <a href="<?php echo e(route('settings.password')); ?>" class="block px-4 py-2 hover:bg-gray-100">Change Password</a>
...
<?php /**PATH C:\Users\Acer\OneDrive\Desktop\Laovista\laovista\resources\views/partials/abc-header.blade.php ENDPATH**/ ?>