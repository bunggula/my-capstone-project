...
<!-- Sidebar Container -->
<div x-data="{ openDropdown: '<?php echo e($defaultDropdown); ?>' }"
    ...
    <!-- Logo -->
        ...
        <img src="<?php echo e($logo); ?>" alt="Barangay Logo" style="height: 80px; object-fit: contain; display: inline-block;">
    </div>

    <!-- Header -->
    <div style="margin-bottom: 32px; text-align: center;">
        <a href="<?php echo e(route('secretary.dashboard')); ?>" style="text-decoration: none; color: #1e3a8a; font-size: 20px; font-weight: 700;">
            Secretary Panel
        </a>
    </div>
    ...
    <nav style="display: flex; flex-direction: column; gap: 16px;">
        ...
        <!-- Dashboard -->
        <a href="<?php echo e(route('secretary.dashboard')); ?>" class="sidebar-link <?php echo e(request()->routeIs('secretary.dashboard') ? 'active' : ''); ?>">
            <i data-lucide="home" class="icon"></i>
            <span>Dashboard</span>
        </a>
        
        
         <a href="<?php echo e(route('secretary.document_requests.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('secretary.document_requests.index') ? 'active' : ''); ?>">
    ...
    <div x-show="openDropdown === 'events'" class="ml-4 mt-2 space-y-1" x-cloak>
        <a href="<?php echo e(url('/secretary/events-announcements')); ?>" class="sidebar-link whitespace-nowrap <?php echo e($active == 'secretary/events-announcements' ? 'active' : ''); ?>">
            <i data-lucide="calendar-check" class="icon"></i>
            <span>Barangay Events</span>
        </a>
        <a href="<?php echo e(route('secretary.announcements.index')); ?>" class="sidebar-link whitespace-nowrap <?php echo e(request()->routeIs('secretary.announcements.index') ? 'active' : ''); ?>">
        ...
        <div>
            ...
            <div x-show="openDropdown === 'population'" class="ml-4 mt-2 space-y-1" x-cloak>
                <a href="<?php echo e(route('secretary.residents.index')); ?>" class="sidebar-link <?php echo e($active == 'secretary/residents' ? 'active' : ''); ?>">
                    <i data-lucide="user" class="icon"></i>
                    <span>List of Residents</span>
                </a>
                <a href="<?php echo e(route('secretary.officials.index')); ?>" class="sidebar-link <?php echo e($active == 'secretary/officials' ? 'active' : ''); ?>">
        ...
        <div>
            ...
            <div x-show="openDropdown === 'reports'" class="ml-4 mt-2 space-y-1" x-cloak>
                <a href="<?php echo e(route('secretary.reports.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('secretary.reports.index') ? 'active' : ''); ?>">
                    <i data-lucide="trash-2" class="icon"></i>
                    <span>Waste Reports</span>
                </a>
                <a href="<?php echo e(route('secretary.reports.services')); ?>" class="sidebar-link <?php echo e(request()->routeIs('secretary.reports.services*') ? 'active' : ''); ?>">
                    <i data-lucide="clipboard-list" class="icon"></i>
                    <span>Service Reports</span>
                </a>
                <a href="<?php echo e(route('vawc_reports.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('vawc_reports.*') ? 'active' : ''); ?>">
                    <i data-lucide="shield" class="icon"></i>
                    <span>VAWC Reports</span>
                </a>
                <a href="<?php echo e(route('secretary.brco.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('secretary.brco.*') ? 'active' : ''); ?>">
        ...
        <!-- Approval Accounts -->
        <a href="/secretary/approval-accounts" class="sidebar-link <?php echo e($active == 'secretary/approval-accounts' ? 'active' : ''); ?>">
            <i data-lucide="user-check" class="icon"></i>
            <span>Residents Approval</span>
        </a>

   <!-- FAQ Management -->
<a href="<?php echo e(route('secretary.faq.index')); ?>" 
   class="sidebar-link <?php echo e(request()->routeIs('secretary.faq.*') ? 'active' : ''); ?>">
...
<a href="<?php echo e(route('secretary.blotter.index')); ?>" 
   class="sidebar-link <?php echo e(request()->routeIs('secretary.blotter.*') ? 'active' : ''); ?>">
...
<?php /**PATH C:\Users\Acer\OneDrive\Desktop\Laovista\laovista\resources\views/partials/secretary-sidebar.blade.php ENDPATH**/ ?>