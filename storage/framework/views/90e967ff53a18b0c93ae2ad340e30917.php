                ...
                <a href="<?php echo e($card['route']); ?>" 
                   class="bg-white rounded-2xl shadow-xl p-6 border border-transparent hover:bg-blue-50 hover:shadow-2xl hover:border-blue-300 transition transform hover:scale-[1.03] duration-300 relative flex flex-col justify-between h-full animate-fade-up">
                    ...
                    <?php if(isset($card['badge'])): ?>
                        <span class="absolute top-4 right-4 bg-<?php echo e($card['badgeColor']); ?>-100 text-<?php echo e($card['badgeColor']); ?>-700 text-sm font-bold px-3 py-1 rounded-full shadow animate-badge">
...
<div class="mt-8">
            <?php echo $__env->make('partials.secretary_chart', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Acer\OneDrive\Desktop\Laovista\laovista\resources\views/dashboard/secretary.blade.php ENDPATH**/ ?>