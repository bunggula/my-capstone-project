...
<div class="flex h-screen bg-gray-100">
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <div class="sticky top-0 z-10 bg-white shadow">
            <?php echo $__env->make('partials.captain-header', ['title' => '📄 Document Requests'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
                ...
                <div class="p-4 rounded shadow border-l-4 bg-blue-100 border-blue-500 text-blue-700 w-64">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-bold"><?php echo e($documents->total()); ?></p>
                        </div>
                    ...
                    <table class="w-full table-auto border text-sm text-left">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            <?php $__empty_1 = true; $__currentLoopData = $documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="<?php echo e($loop->even ? 'bg-gray-50' : 'bg-white'); ?> hover:bg-gray-100 transition">
                                    <td class="px-6 py-4"><?php echo e($documents->firstItem() + $loop->index); ?></td>
                                    <td class="px-6 py-4 font-medium text-gray-700"><?php echo e($document->name); ?></td>
                                    <td class="px-6 py-4">
                                        <?php if($document->purposes->isEmpty()): ?>
                                            <span class="text-gray-400 text-sm">No purposes yet</span>
                                        <?php else: ?>
                                            <ul class="list-disc list-inside text-gray-600">
                                                <?php $__currentLoopData = $document->purposes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $purpose): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <li><?php echo e($purpose->purpose); ?> - ₱<?php echo e(number_format($purpose->price, 2)); ?></li>
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex space-x-2 items-center">
                                            <!-- Edit Button -->
                                            <button onclick="fetchDocument(<?php echo e($document->id); ?>)" 
                                            ...
                                            <!-- Delete Button -->
                                            <button onclick="confirmDelete(<?php echo e($document->id); ?>)" 
                                            ...
                                            <!-- Hidden delete form -->
                                            <form id="delete-form-<?php echo e($document->id); ?>" action="<?php echo e(route('captain.manage.destroy', $document->id)); ?>" method="POST" class="hidden">
                                                <?php echo csrf_field(); ?>
...
<div id="addModal" class="fixed inset-0 bg-black bg-opacity-50 hidden flex items-center justify-center z-50">
    <div class="bg-white rounded-xl shadow-lg w-full max-w-xl p-6">
        ...
        <form action="<?php echo e(route('captain.manage.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="mb-4">
...
function fetchDocument(id) {
    fetch("<?php echo e(url('/captain/manage')); ?>/" + id + "/edit")
        .then(res => res.json())
        .then(data => {
            document.getElementById('editForm').action = "<?php echo e(url('/captain/manage')); ?>/" + id;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Acer\OneDrive\Desktop\Laovista\laovista\resources\views/captain/manage/index.blade.php ENDPATH**/ ?>