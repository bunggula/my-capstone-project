    ...
    <div class="footer">
        ...
        <?php if($abcAdmin): ?>
            ...
            <div class="prepared" style="margin-top:60px; text-align:right;">
                <p><strong>Prepared by:</strong> <?php echo e($fullName); ?></p>
                <p>ABC President</p>
            </div>
        <?php else: ?>
            <div class="prepared" style="margin-top:60px; text-align:right;">
...
<?php /**PATH C:\Users\Acer\OneDrive\Desktop\Laovista\laovista\resources\views/abc/residents/print.blade.php ENDPATH**/ ?>