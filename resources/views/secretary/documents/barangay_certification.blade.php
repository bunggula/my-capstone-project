        ...
        <div class="content-section">
            <div class="content">
                ...
                <p>
                    ...
                    is a bonafide resident of Barangay <strong>{{ $barangay->name ?? '__________' }}</strong>, 
                   {{ $municipality->name ?? '' }}, Pangasinan.
                </p>

                <p>
                    This certification is issued upon the request of <strong>Mr./Ms. {{ $request->resident->full_name ?? '__________' }}</strong> 
                    for whatever legal purpose it may serve.
                </p>

                <p>
                    Given this {{ \Carbon\Carbon::parse($request->pickup_date)->format('jS') }} day of 
                    {{ \Carbon\Carbon::parse($request->pickup_date)->format('F Y') }}, at Barangay {{ $barangay->name ?? '' }}, {{ $municipality->name ?? '' }}, Pangasinan.
.
                </p>
                <div class="signature">
