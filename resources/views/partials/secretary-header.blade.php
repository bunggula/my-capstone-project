...
<div class="bg-blue-900 px-6 py-4 flex justify-between items-center border-b border-gray-300 z-20 relative">
    ...
    <div x-cloak x-data="{ open: false }" class="relative">
        <button @click="open = !open"
            ...
            {{ ucfirst(Auth::user()->role) }} {{ Auth::user()->first_name }} — Barangay {{ Auth::user()->barangay->name ?? 'N/A' }}
        ...
        <div x-show="open" @click.away="open = false" x-transition
            ...
            <a href="{{ route('settings.profile') }}" class="block px-4 py-2 hover:bg-gray-100 transition">
                Edit Profile
            </a>
            <a href="{{ route('settings.password') }}" class="block px-4 py-2 hover:bg-gray-100 transition">
                Change Password
            </a>
