...
const residentsStatus = @json($residentCategories);

const requestsCompleted = @json($requestsChartData);
...
const proposalsApproved = @json($proposalsApproved);
const proposalsPending = @json($proposalsPending);
const proposalsRejected = @json($proposalsRejected);
const approvedResidentsCount = @json($approvedResidentsCount);
...
document.addEventListener('DOMContentLoaded', function() {
    const concernsPerMonth = @json($concernsPerMonth);
    const months = @json($months);
