...
<p>If you believe this was a mistake, please visit your <strong>Barangay {{ $resident->barangay->name ?? 'office' }}</strong> to resolve the issue or contact them directly for clarification.</p>
        ...
        @if(isset($approver))
    <p><em>Rejected by: {{ $approver->full_name ?? $approver->name ?? 'Barangay Secretary' }}</em></p>
@endif
